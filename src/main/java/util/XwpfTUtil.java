...
public class XwpfTUtil {
...

    {
        ...
        params.put("${place}", "广西桂平");
        params.put("${classes}", "3102");
        params.put("${id}", "3901130816");
        params.put("${qq}", "1456943876");
        params.put("${tel}", "13924569321");
        params.put("${oldJob}", "研发中心干事");
        params.put("${swap}", "是");
        params.put("${first}", "研发中心");
        params.put("${second}", "综合事务部");
        params.put("${award}", "曾参加大数据竞赛获得第三名");
